...
var context = document.getElementById('future_stock_graph').getContext('2d');
var lds=[];
//create time span
...
/*메인주가 */
var stock_now = document.getElementById('stock_now').getContext('2d');
var lds=[];
for (var i=0; i<200; i++){lds.push(i);}
var data = {
                    labels : lds,
    ...
    var myStock = new Chart(stock_now, {
                type: 'line',
                data: data,
                options: options_now
    });
    ...
    function Hi2(dds, lds){
            ...
            //lds.push(80);
            updateArr(dds);
            myStock.update();    //차트 업데이트
       
    }
    setInterval(Hi2, 1000, dds, lds);
