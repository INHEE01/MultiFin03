...
public class RealEstateSvcSHRentAPI {
	...
	public static final String REQUEST_URL = "http://openapi.molit.go.kr:8081/OpenAPI_ToolInstallPackage/service/rest/RTMSOBJSvc/getRTMSDataSvcSHRent";
	
	public static final SimpleDateFormat sdf1 = new SimpleDateFormat("yyyyMMdd");
	public static final SimpleDateFormat sdf2 = new SimpleDateFormat("yyyy-MM-dd");
	
	public static void main(String[] args) throws IOException {
		parsingRealEstateSvcSHRent("11110","2023");
	}
	
	public static List<RealEstateSvcSHRent> parsingRealEstateSvcSHRent(String LAWD_CD, String DEAL_YMD) throws IOException {
			...
			for (int i = 0; i < nList.getLength(); i++) {
				...
				if(node.getNodeType() == Node.ELEMENT_NODE) {
					try {
						...
						String Building_Area = getStrData(eElement, "계약면적");
						...
						//새로운 re 객체 생성
						RealEstateSvcSHRent re = new RealEstateSvcSHRent(realEstateDealNo, Build_Year,Building_Area, Deal_Year, Dong,Deal_Month,Deposit,
								Monthly_Rent,Deal_Day, Regional_Code);
						// list에 저장
						list.add(re);
