package com.multi.multifin.board.model.vo;
...
//	@JoinColumn(name = "r_no") // 리플의 외래키의 네이밍을 설정할때, 대부분 PK로 자동셋팅 됨으로 굳이 필요 없음
	...
	public String toString() {
		return "Board [bNo=" + bNo + ", title=" + title + ", content=" + content + ", originalFileName="
				+ originalFileName + ", renamedFileName=" + renamedFileName + ", readCount=" + readCount + ", type="
				+ type + ", createDate=" + createDate + ", modifyDate=" + modifyDate + ", replyList=" + replyList
				+ ", member=" + member + "]";
	}
}
