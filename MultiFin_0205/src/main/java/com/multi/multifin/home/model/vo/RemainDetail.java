...
public class RemainDetail {
	...
	Date cntrctCnclsBgnde;			// varchar(30), -- 계약시작일                  
	Date cntrctCnclsRndde;			// varchar(30), -- 계약종료일                  
	Date gnrlRceptBgnde ;			//varchar(30), -- 특별공급접수시작일            
	Date gnrlRceptEndde ;			//varchar(30),  -- 특별공급접수종료일           
	...
	Date przwnerPresnatnDe ;		//varchar(30), -- 당첨자발표일               
	Date rcritPblancDe  ;			// varchar(30), -- 모집공고일                   
	Date spsplyRceptBgnde ;			// varchar(30), -- 특별공급 접수시작일        
	Date spsplyRceptEndde  ;		//varchar(30), -- 특별공급 접수종료일        
	Date subscrptRceptBgnde ;		// varchar(30), -- 청약접수시작일           
	Date subscrptRceptEndde ;		//varchar(30), -- 청약접수종료일            
