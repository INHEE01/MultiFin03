...
public class Aptdetail {
	...
	Date cntrctCnclsEndde ; 				// DATETIME,	-- 계약종료일                             
	Date gnrlRnk1CrspareaRceptPd  ; 	// DATETIME,	-- 1순위 접수일 해당지역     
	Date gnrlRnk1EtcAreaRcptdePd ; 	// DATETIME,	-- 1순위 접수일 경기지역      
	...
	Date rceptBgnde ; 						// DATETIME,	-- 청약접수시작일                             
	Date rceptEndde;						 // DATETIME,	-- 청약접수종료일                              
	Date rcritPblancDe  ; 				// DATETIME,	-- 모집공고일                            
	String rentSecdNm  ; 					// varchar(10), -- 분양구분코드명                           
	char specltRdnEarthAt  ; 			// char(1), -- 투기과열지구                          
	Date spsplyRceptBgnde   ; 			// DATETIME, -- 특별공급 접수시작일                  
